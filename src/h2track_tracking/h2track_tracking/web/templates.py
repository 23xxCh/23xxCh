"""HTML templates and report generation functions for the web console.

This module contains pure template utilities with no dependencies on other web modules.
"""
