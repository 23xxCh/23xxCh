...
Scenes are stored in h2track_bringup/scenes/<scene_name>/scene.yaml
"""
...
from .paths import get_h2track_bringup_share_path, get_h2track_sim_share_path, get_workspace_root
...
class SceneManager:
    ...
    def __init__(self, scenes_dir: Path | None = None) -> None:
        ...
        Args:
            scenes_dir: Directory containing scene subdirectories.
                       If None, uses h2track_bringup share directory.
        """
    ...
    def scenes_dir(self) -> Path:
        ...
        # Try h2track_bringup share path
        share_path = get_h2track_bringup_share_path()
        if share_path:
            return share_path / "scenes"

        # Fallback to source directory
        workspace = get_workspace_root()
        return workspace / "src" / "h2track_bringup" / "scenes"
