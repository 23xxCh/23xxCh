...
def generate_launch_description():
    lc = {name: LaunchConfiguration(name) for name in [
        ...
        "dynamic_source_threshold", "source_plateau_window", "source_plateau_ratio",
    ...
    declares = [
        ...
        DeclareLaunchArgument("dynamic_source_threshold", default_value="false"),
        DeclareLaunchArgument("source_plateau_window", default_value="10"),
        DeclareLaunchArgument("source_plateau_ratio", default_value="0.1"),
        ...
        DeclareLaunchArgument("estimate_wind", default_value="gradient"),
    ...
    bt_mission_node = Node(
        ...
        parameters=[
            {"use_sim_time": lc["use_sim_time"]},
            {
                ...
                "dynamic_source_threshold": ParameterValue(lc["dynamic_source_threshold"], value_type=bool),
                "source_plateau_window": lc["source_plateau_window"],
                "source_plateau_ratio": lc["source_plateau_ratio"],
                ...
                "estimate_wind": lc["estimate_wind"],
                "use_fusion": True,
